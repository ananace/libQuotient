...
BuildRequires: opt-gcc%{version_opt_gcc}
...
%cmake \
    -DCMAKE_CXX_COMPILER=/opt/gcc%{version_opt_gcc}/bin/g++ \
    -DCMAKE_SHARED_LINKER_FLAGS="-L/opt/gcc%{version_opt_gcc}/lib -static-libstdc++" \
